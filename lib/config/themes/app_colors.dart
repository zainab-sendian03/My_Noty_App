...
class AppColors {
  ...
  static const Color baseColor = Color.fromARGB(255, 235, 142, 2);
  ...
  static const Color primaryVariantLight =
      Color.fromARGB(255, 200, 120, 2); // Darker orange
  static const Color primaryVariantLight2 =
      Color.fromARGB(255, 255, 180, 50); // Lighter orange

  // Secondary colors - complementary to orange (blue tones)
  static const Color secondaryLight =
      Color.fromARGB(255, 255, 94, 77); // Coral red
  static const Color secondaryVariantLight =
      Color.fromARGB(255, 220, 70, 60); // Darker blue
  ...
  static const Color warningLight =
      Color.fromARGB(255, 255, 165, 0); // Orange-based warning
  ...
  static const Color primaryDark =
      Color.fromARGB(255, 255, 165, 0); // Brighter orange for dark mode
  static const Color primaryVariantDark =
      Color.fromARGB(255, 235, 142, 2); // Base orange
  static const Color primaryVariantDark2 =
      Color.fromARGB(255, 200, 120, 2); // Darker orange

  // Secondary colors for dark mode
  static const Color secondaryDark =
      Color.fromARGB(255, 255, 130, 100); // Lighter coral for dark
  static const Color secondaryVariantDark =
      Color.fromARGB(255, 255, 94, 77); // Base blue
  ...
  static const Color warningDark =
      Color.fromARGB(255, 255, 200, 50); // Orange-based warning for dark
